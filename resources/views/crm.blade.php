    ...
    <div class="breadcrumb-wrapper" style="background-color: transparent !important">
        ...
        <div class="container-default">
            <div class="breadcrumb-block">
                <h1 class="breadcrumb-title">AI Based Customer Relationship Management</h1>
        ...
        <div class="section-space">
            ...
            <div class="container-default">
                ...
                <div class="mx-auto max-w-[1080px]">
                    <!-- Service main Image -->
                    <img src="{{ asset('assets/img/kodetech/products/CRM.png') }}" alt="service-main-img" class="mb-10 h-auto w-full rounded-[10px]" />
                    <!-- Service Rich Text -->
                    <div class="rich-text">

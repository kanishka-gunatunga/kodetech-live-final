    ...
    <div class="breadcrumb-wrapper" style="background-color: transparent !important">
        ...
        <div class="container-default">
            <div class="breadcrumb-block">
                <h1 class="breadcrumb-title">E-Commerce solutions</h1>
        ...
        <div class="section-space">
            ...
            <div class="container-default">
                ...
                <div class="mx-auto max-w-[1080px]">
                    <!-- Service main Image -->
                    <img src="{{ asset('assets/img/kodetech/products/e commerce 1.png') }}" alt="service-main-img" class="mb-10 h-auto w-full rounded-[10px]" />
                    <!-- Service Rich Text -->
                    <div class="rich-text">

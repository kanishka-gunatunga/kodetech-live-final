    ...
    <div class="section-careers">
        ...
        <div class="section-space">
            ...
            <div class="container-default">
                ...
                <div
                    class="jos mb-[60px] flex flex-wrap justify-center gap-10 text-center lg:mb-20 xl:justify-between xl:text-left">
                ...
                <div class="tab-content grid gap-6 md:grid-cols-2" id="all">
                    ...
                    @foreach ($careers as $career)
                        ...
                        <div class="jos" data-jos_delay="0">
                            <div
                                class="group rounded-[10px] border border-[#E6E6E6] bg-white p-[30px] transition-all duration-300 hover:border-ColorOffWhite hover:bg-ColorOffWhite md:p-10">
                                <div class="mb-[15px] text-xl font-semibold tracking-tighter text-ColorBlack md:text-2xl">
                                    {{ $careers[0]->career_name }}
                                </div>
                                ...
                                <a href="{{route('CareerShow',$career->slug)}}"
                                    {{-- <a href="careerdetails" --}}
                                    class="inline-flex items-center gap-x-2 text-base font-bold text-ColorBlack group-hover:text-ColorBlue">Apply
                                    now
                ...
                <div class="jos mt-10 flex justify-center lg:mt-20">
                    <a href="{{ url('contact') }}" class="btn is-blue is-rounded btn-animation is-large group"><span>Can’t
                            find your role? Contact us</span></a>
                </div>
            </div>
            <!-- Section Container -->
        </div>

...
@section('content')
                        ...
                        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-10 xl:gap-10">
                            ...
                            <div class="jos order-2 md:order-2" data-jos_animation="fade-right">
                                ...
                                <p style="color: #000 !important" class="mb-5">
                                    Kode Tech (Pvt) Ltd is a well-established and renowned software development company with
                                    a rich legacy spanning over 15 years.
                                </p>
                                {{-- <hr class="mb-5" /> --}}
                                <p style="color: #000 !important" class="mb-5">
                                    Our extensive expertise has earned us a strong foothold in 15 international markets,
                                    where we’ve successfully delivered over 1,500 projects. Our innovative and creative
                                    approach and cutting-edge technologies always help deliver a better experience.
                                    Our extensive expertise has earned us a strong foothold in 15 international markets,
                                    where we’ve successfully delivered over 1,500 projects.
                                </p>
                                <p style="color: #000 !important">
                                    Our innovative and creative approach and cutting-edge technologies always help for a
                                    better experience.
                                </p>
                            </div>
                            <!-- Content Block Left -->
                            ...
                            <div class="jos relative order-1 md:order-1"
                                style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15); border-radius: 32px !important"
                                data-jos_animation="fade-left">
                                <!-- Content Image -->
                                <img src="{{ asset('assets/img/kodetech/about-content-image.png') }}" alt="content-img-1"
                                    width="523" height="450" class="h-auto w-full rounded-[32px]"
    ...
    <div class="section-brand bg-[#1B1C1D] black-section">
        <div class="jos">
            ...
            <div class="pb-[60px] md:pb-20 lg:pb-[100px] pt-[60px] md:pt-20 lg:pt-[100px]">
                <!-- Section Container -->
                <div class="container-default">
                    <div class="mx-auto mb-10 max-w-[80%] text-center text-white text-xl font-semibold leading-[1.4] opacity-70 md:mb-10 lg:mb-10 lg:max-w-2xl"
                        style="color: #ffffff !important; font-family: 'Public Sans', sans-serif; font-weight: 700 !important; font-size: 24px !important;">
                    ...
                    <div class="swiper brand-slider">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="jos mb-6 break-inside-avoid shadow rounded-md p-2 flex justify-center align-middle items-center">
                                    <div class="flex flex-col rounded-[10px] bg-white text-ColorBlack"
                                        style="height: auto; width: max-content; display: flex; justify-content: center; align-items: center;">
                                        <img src="{{ asset('assets/img/kodetech/partners/Logo 7.png') }}"
                                            alt="icon-green-star" width="100" height="80" class="img-fluid"
                                            style="width: 100%;" />
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="flex flex-col rounded-[10px] bg-white text-ColorBlack"
                                        style="height: auto; width: max-content; display: flex; justify-content: center; align-items: center;">
                                        <img src="{{ asset('assets/img/kodetech/partners/Logo 8.png') }}"
                                            alt="icon-green-star" width="100" height="80" class="img-fluid"
                                            style="width: 100%;" />
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="flex flex-col rounded-[10px] bg-white text-ColorBlack"
                                        style="height: auto; width: max-content; display: flex; justify-content: center; align-items: center;">
                                        <img src="{{ asset('assets/img/kodetech/partners/Logo 9.png') }}"
                                            alt="icon-green-star" width="100" height="80" class="img-fluid"
                                            style="width: 100%;" />
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="flex flex-col rounded-[10px] bg-white text-ColorBlack"
                                        style="height: auto; width: max-content; display: flex; justify-content: center; align-items: center;">
                                        <img src="{{ asset('assets/img/kodetech/partners/Logo 10.png') }}"
                                            alt="icon-green-star" width="100" height="80" class="img-fluid"
                                            style="width: 100%;" />
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="flex flex-col rounded-[10px] bg-white text-ColorBlack"
                                        style="height: auto; width: max-content; display: flex; justify-content: center; align-items: center;">
                                        <img src="{{ asset('assets/img/kodetech/partners/IG logo.png') }}"
                                            alt="icon-green-star" width="100" height="80" class="img-fluid"
                                            style="width: 100%;" />
                                    </div>
                                </div>
                ...
                <div class="container-default">
                    ...
                    <div class="jos mb-[60px] xl:mb-20">
                        ...
                        <div class="mx-auto section-max-width-2">
                            ...
                            {{-- <div
                                ...
                                Kode Tech (Pvt) Ltd is a well-established and renowned software development company with a rich legacy spanning over 15 years.
                            </div> --}}
                            ...
                            <p class="text-center">
                                With over 15 years of experience, we are a trusted software development company…
                            </p>
                        </div>
                        <!-- Section Content Block -->
                    </div>
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        ...
                        <div class="jos" data-jos_delay="0">
                            <div
                                class="group rounded-[10px] border-0 bg-[#F4F4F4] p-8 transition-all duration-300 ease-in-out hover:border-ColorOffWhite hover:bg-ColorOffWhite lg:p-10 h-full">
                                <div class="flex flex-col gap-x-10 gap-y-6 sm:gap-y-8 lg:flex-row">
                                    <div class="flex-1 text-center lg:text-left">
                                        ...
                                        <p class="mb-5 line-clamp-5 text-ColorBlack/80">
                                            We prioritize innovation to deliver impactful solutions. By adopting emerging
                                            technologies and creative thinking, we empower businesses to thrive in a
                                            competitive landscape, ensuring every project reflects our passion for driving
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-x-10 gap-y-6 sm:gap-y-8 lg:flex-row">
                                    <div class="flex-1 text-center lg:text-left">
                                        ...
                                        <p class="mb-5 line-clamp-5 text-ColorBlack/80">
                                            Our clients’ success fuels ours. We focus on understanding their unique
                                            challenges, crafting customized solutions, and building lasting partnerships. By
                                            putting customers first, we ensure satisfaction, trust, and exceptional value in
                                            every interaction and delivery.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-x-10 gap-y-6 sm:gap-y-8 lg:flex-row">
                                    <div class="flex-1 text-center lg:text-left">
                                        ...
                                        <p class="mb-5 line-clamp-5 text-ColorBlack/80">
                                            Integrity is the cornerstone of our operations. We are dedicated to ethical
                                            practices, transparent communication, and delivering outstanding quality.
                                            Excellence is not just a goal—it’s our promise to every client and project we
                                            undertake.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-x-10 gap-y-6 sm:gap-y-8 lg:flex-row">
                                    <div class="flex-1 text-center lg:text-left">
                                        ...
                                        <p class="mb-5 line-clamp-5 text-ColorBlack/80">
                                            We believe that teamwork drives success. By fostering a culture of collaboration
                                            and continuous learning, we enable our teams and partners to achieve shared
                                            goals, build enduring relationships, and grow together in a dynamic business
                                            environment.
                                        </p>
                                    </div>
                                </div>
    ...
    <!--                    </h2>-->
    <!--                    <p class="text-center">-->
    <!--                        Kode Tech (Pvt) Ltd is a well-established and renowned software development company with a rich-->
    <!--                        legacy spanning over 14 years.-->
    <!--                    </p>-->
    <!--                </div>-->
    <!-- Section Content Block -->
    <!--            </div>-->
    ...
    <!-- Video Block -->
    <div class="jos">
        <div class="relative flex items-center justify-center" style="padding:3px;">
            <img src="{{ asset('assets/img/kodetech/Kodetech Website Intro Video 2.jpg') }}" alt="video-img"
                width="1200" height="740" class="" />
            <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=M-AluZC9Buc"
                ...
                <span class="text-2xl transition-all duration-300 ease-linear group-hover:scale-110"><i
                        ...
                        <div class="swiper-wrapper">
                            ...
                            @foreach ($testimonials as $testimonial)
                                <div class="swiper-slide">
                                    ...
                                    <!-- Testimonial Item -->
                                    <div class="jos mb-6 break-inside-avoid rounded-md"
                                        style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15);">
                                        <div
                                            class="flex flex-col rounded-[10px] bg-white testimonial-card p-6 text-ColorBlack sm:p-[30px]">
                                            <!-- Review Star -->
                                            <div class="mb-5 flex gap-[5px] text-2xl lg:mb-[30px]">
                                                @for ($i = 0; $i < 5; $i++)
                                                    @if ($i < $testimonial->rating)
                                                        <img src="{{ asset('assets/img/kodetech/Star 1.png') }}"
                                                            alt="filled-star" width="26" height="24" />
                                                    @else
                                                        <img src="{{ asset('assets/img/kodetech/Star-empty.png') }}"
                                                            alt="empty-star" width="26" height="24" />
                                                    @endif
                                                @endfor
                                            </div>

                                            <div class="mb-1 font-semibold">
                                                {{ $testimonial->review_overview }}
                                            </div>
                                            <p class="mb-6 testimonial-text">
                                                {{ $testimonial->review_message }}
                                            </p>
                                            <div class="flex items-center gap-4">
                                                <img src="{{ $testimonial->testimonial_client_image
                                                    ? asset('storage/' . $testimonial->testimonial_client_image)
                                                    : asset('assets/img/avatar.png') }}"
                                                    alt="testimonial-avatar" width="60" height="60"
                                                    class="h-[60px] w-[60px] rounded-[50%]" />
                                                <div>
                                                    <span class="block font-semibold">
                                                        {{ $testimonial->client_name }}</span>
                                                    <span class="text-sm text-opacity-80">
                                                        {{ $testimonial->client_designation }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
